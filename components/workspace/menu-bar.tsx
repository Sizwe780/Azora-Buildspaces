...
export function MenuBar({ className }: MenuBarProps) {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          shortcut: "Ctrl+H",
          action: () => {
            /* Monaco built-in replace */
          },
        },
        {
          label: "Find in Files",
          shortcut: "Ctrl+Shift+F",
          action: () => wb.setSidebarView("search"),
        },
        { type: "separator" },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          label: "Quick Open",
          shortcut: "Ctrl+P",
          action: () => wb.setQuickOpenVisible(true),
        },
        { type: "separator" },
        {
          label: "Explorer",
          shortcut: "Ctrl+Shift+E",
          action: () => wb.setSidebarView("explorer"),
        },
        {
          label: "Search",
          shortcut: "Ctrl+Shift+F",
        ...
        },
        {
          ...
          action: () => wb.setSidebarView("git"),
        },
        {
          label: "Debug",
          shortcut: "Ctrl+Shift+D",
          action: () => wb.setPanelView("debug"),
        },
        {
          label: "Extensions",
          shortcut: "Ctrl+Shift+X",
          action: () => wb.setSidebarView("extensions"),
        },
        { type: "separator" },
        {
          label: "Terminal",
          shortcut: "Ctrl+`",
          action: () => wb.setPanelView("terminal"),
        },
        {
          label: "Problems",
          shortcut: "Ctrl+Shift+M",
          action: () => wb.setPanelView("problems"),
        },
        {
          label: "Output",
          shortcut: "Ctrl+Shift+U",
          action: () => wb.setPanelView("output"),
        },
        { type: "separator" },
        {
        ...
        },
        {
          ...
          shortcut: "Ctrl+K Z",
          action: () => wb.toggleZenMode(),
        },
        { type: "separator" },
        {
          label: "Split Editor",
          shortcut: "Ctrl+\\",
          action: () => wb.splitEditor("horizontal"),
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          shortcut: "Ctrl+G",
          action: () => wb.setGoToLineVisible(true),
        },
        { type: "separator" },
        {
        ...
        { type: "separator" },
        {
          label: "Go Back",
          shortcut: "Alt+Left",
          action: () => wb.navigateBack(),
        },
        {
          label: "Go Forward",
          shortcut: "Alt+Right",
          action: () => wb.navigateForward(),
        },
        { type: "separator" },
        {
          label: "Next Problem",
    ...
    },
    {
      ...
      items: [
        ...
        { type: "separator" },
        {
          ...
          action: () => wb.setSidebarView("task-runner"),
        },
        {
          label: "Run Test Task",
          action: () => wb.setSidebarView("task-runner"),
          ...
          action: () => {
            ...
            if (activeId) {
              ...
              if (file) {
                ...
                window.dispatchEvent(
                  new CustomEvent("terminal:run", { detail: { command: cmd } }),
                );
              }
            }
          },
      ...
      items: [
        {
          label: "Welcome",
          action: () =>
            window.dispatchEvent(new CustomEvent("workbench:show-welcome")),
        },
        {
        ...
        },
        {
          ...
          action: () => wb.setSidebarView("settings"),
        },
        { type: "separator" },
        {
          label: "About",
          action: () =>
            window.dispatchEvent(new CustomEvent("workbench:show-about")),
        },
      ],
    },
  ];
  ...
  return (
    <div
      className={cn(
        "flex items-center h-10 bg-[var(--ide-menu-bar-bg)] border-b border-[var(--ide-menu-border)] select-none",
        className,
      )}
    >
      {menus.map((menu) => (
        <DropdownMenu
          key={menu.id}
          onOpenChange={(open) => setActiveMenu(open ? menu.id : null)}
        >
            ...
            {menu.items.map((item, index) => {
              if (item.type === "separator") {
                return (
                  <DropdownMenuSeparator
                    key={index}
                    className="bg-[var(--ide-menu-border)]"
                  />
                );
              }
              return (
                ...
                >
                  ...
                  {item.shortcut && (
                    <span className="text-xs text-[var(--ide-text-muted)] ml-4">
                      {item.shortcut}
                    </span>
                  )}
                </DropdownMenuItem>
