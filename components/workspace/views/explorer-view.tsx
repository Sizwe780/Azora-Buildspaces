...
export function ExplorerView() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Header */}
      <div
        className="p-1.5 text-[11px] font-bold text-muted-foreground uppercase tracking-wider flex items-center justify-between border-b border-border/30"
        role="heading"
        aria-level={1}
      >
          ...
          <div className="pb-1">
            {uniqueOpenFiles.map((fileId) => {
              ...
              return (
                <div
                  key={fileId}
                  className={`flex items-center gap-1.5 px-2 py-0.5 text-sm cursor-pointer group ${isActive
                      ? "bg-accent/20 text-accent"
                      : "text-muted-foreground hover:text-foreground hover:bg-muted/50"
                    }`}
      ...
      <div
        className={`border-b border-border/30 ${explorerExpanded ? "flex-1 min-h-0 flex flex-col" : ""}`}
      >
        <div
        ...
        >
          ...
          {explorerExpanded && (
            <div
              className="flex items-center gap-0.5 opacity-0 group-hover/section:opacity-100 transition-opacity"
              onClick={(e) => e.stopPropagation()}
            >
              <Button
                variant="ghost"
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem
                    onClick={() => createFile(rootId || null, "new-file.txt")}
                  >
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      createDirectory(rootId || null, "new-folder")
                    }
                  >
      ...
      {/* ─── OUTLINE Section ─── */}
      <div
        className={`border-b border-border/30 ${outlineExpanded ? "min-h-[120px] max-h-[40%] flex flex-col" : ""}`}
      >
        <div
          className="flex items-center gap-1 px-1.5 py-1 text-[11px] font-semibold text-muted-foreground uppercase tracking-wider cursor-pointer hover:bg-muted/30 transition-colors group/section"
          ...
          {outlineExpanded && (
            ...
            >
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={() => setOutlineExpanded(false)}>
                    Hide Outline
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            ...
            <OutlineView
              ...
              onNavigateToLine={(file, line) => {
                window.dispatchEvent(
                  new CustomEvent("azora:navigateToLine", {
                    detail: { file, line },
                  }),
                );
              }}
      ...
      {/* ─── TIMELINE Section ─── */}
      <div
        className={`${timelineExpanded ? "min-h-[120px] max-h-[40%] flex flex-col" : ""}`}
      >
        <div
          className="flex items-center gap-1 px-1.5 py-1 text-[11px] font-semibold text-muted-foreground uppercase tracking-wider cursor-pointer hover:bg-muted/30 transition-colors group/section"
          ...
          {timelineExpanded && (
            ...
            >
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={() => setTimelineExpanded(false)}>
                    Hide Timeline
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
